...
\item We start by finding the smallest representative greater than or equal to $x$. %Time??
...
\item %Not sure. Do the elements stored in the tree contain pointers to the linked list?  If not, updating this could be prohibitively slow.
\end{enumerate}
\end{document}