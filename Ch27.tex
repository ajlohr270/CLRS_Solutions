...
See the computation dag in the image below. Assuming that each strand takes unnit time, the work is 15, the span is 6, and the parallelism is $\frac{5}{3}$

\includegraphics[scale=.1]{27(2(1))}
